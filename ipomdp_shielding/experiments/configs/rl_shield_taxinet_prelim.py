...
config = RLShieldExperimentConfig(
    ...
    rl_cache_path="/tmp/prelim_rl_shield_taxinet_agent.pt",
    opt_cache_path="/tmp/prelim_rl_shield_taxinet_opt_realization.json",
    results_path="./data/prelim/rl_shield_taxinet_results.json",
    figures_dir="./data/prelim/rl_shield_taxinet_figures",
)
