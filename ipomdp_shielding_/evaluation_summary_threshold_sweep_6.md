...
![Overview bar charts](results/sweep_v6/summary_v6_bars.png)
...
![Pareto scatter](results/sweep_v6/pareto_v6_taxinet.png)

> *Each point is one threshold setting. Only t=0.90 and t=0.95 are labelled. No lines connect points.*

![Bar chart — best threshold per shield](results/sweep_v6/barchart_v6_taxinet.png)
...
| Carr | — | 8% | 92% | — | 4% | 96% |
| Fwd-Sampling | 0.95 | 38% | 28% | 0.95 | 46% | 22% |
...
![Pareto scatter](results/sweep_v6/pareto_v6_obstacle.png)

> *Each point is one threshold setting. Only t=0.90 and t=0.95 are labelled. No lines connect points.*

![Bar chart — best threshold per shield](results/sweep_v6/barchart_v6_obstacle.png)
...
| Carr | — | 2% | 98% | — | 2% | 98% |
| Fwd-Sampling | 0.95 | 8% | 84% | 0.95 | 10% | 82% |
...
![Bar chart — best threshold per shield](results/sweep_v6/barchart_v6_cartpole_lowacc.png)
...
| Carr | — | 2% | 0% | — | 2% | 0% |
| Fwd-Sampling | 0.50 | 0% | 0% | 0.70 | 1% | 0% |
...
![Bar chart — best threshold per shield](results/sweep_v6/barchart_v6_refuel_v2.png)
...
| Fwd-Sampling | 0.50 | 0% | 78% | 0.80 | 0% | 90% |
