...
![Overview bar charts](summary_v5_bars.png)
...
![Pareto scatter](pareto_v5_taxinet.png)

> *Each point is one threshold setting. Only t=0.90 and t=0.95 are labelled. No lines connect points.*

![Bar chart — best threshold per shield](barchart_v5_taxinet.png)
...
![Pareto scatter](pareto_v5_obstacle.png)

> *Each point is one threshold setting. Only t=0.90 and t=0.95 are labelled. No lines connect points.*

![Bar chart — best threshold per shield](barchart_v5_obstacle.png)
...
![Bar chart — best threshold per shield](barchart_v5_cartpole_lowacc.png)
...
![Bar chart — best threshold per shield](barchart_v5_refuel_v2.png)
