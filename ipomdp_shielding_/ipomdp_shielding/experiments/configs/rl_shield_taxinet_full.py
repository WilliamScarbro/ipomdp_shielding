...
config = RLShieldExperimentConfig(
    ...
    rl_cache_path="results/cache/full_rl_shield_taxinet_agent.pt",
    opt_cache_path="results/cache/full_rl_shield_taxinet_opt_realization.json",
    results_path="results/full/rl_shield_taxinet_results.json",
    figures_dir="results/full/rl_shield_taxinet_figures",
)
