"""Final RL shielding experiment configuration for TaxiNetV2."""
...
config = RLShieldExperimentConfig(
    ...
    results_path="results/taxinet_v2/rl_shield_taxinet_v2_results.json",
    figures_dir="results/taxinet_v2/rl_shield_taxinet_v2_figures",
    ipomdp_kwargs={
