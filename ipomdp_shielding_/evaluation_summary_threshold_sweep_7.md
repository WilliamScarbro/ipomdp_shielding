...
![Overview bar charts](results/sweep_v7/summary_v7_bars.png)
...
![Pareto scatter](results/sweep_v7/pareto_v7_taxinet.png)

> *Each point is one threshold setting. Only t=0.90 and t=0.95 are labelled. No lines connect points.*

![Bar chart — best threshold per shield](results/sweep_v7/barchart_v7_taxinet.png)
...
![Pareto scatter](results/sweep_v7/pareto_v7_obstacle.png)

> *Each point is one threshold setting. Only t=0.90 and t=0.95 are labelled. No lines connect points.*

![Bar chart — best threshold per shield](results/sweep_v7/barchart_v7_obstacle.png)
...
![Bar chart — best threshold per shield](results/sweep_v7/barchart_v7_cartpole_lowacc.png)
...
![Bar chart — best threshold per shield](results/sweep_v7/barchart_v7_refuel_v2.png)
